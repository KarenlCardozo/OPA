...
-css
	...
	-style.css// Esta hoja de estilo fue descargada de la página "Iconmoon" y es quiién se encarga de proporcionar estilados a las funtes	 		(iconos) que utilizamos en la página web.
...
-----------------
Ejemplo:
	JSON (Detallar que archivos JSON utilizados y carpeta en la cual se encuentran) localizados

	Ajax (Funcionalidades donde se hicieron llamadas con ajax)


Librerias utilizadas
--------------------
Ejemplo: (Boostrap, Jquery)
...
y que no esta comprendido en las secciones previas.
